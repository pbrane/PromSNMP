...
/*
    ...
    public ResponseEntity<String> snmpMetrics(
            @Parameter(description = "Target in the current Inventory", example = "myrouter.metrics.com, 192.168.1.1")
...
*/
    ...
    public void metrics(@Parameter(description = "Target in the current Inventory", example = "myrouter.metrics.com, 192.168.1.1")
